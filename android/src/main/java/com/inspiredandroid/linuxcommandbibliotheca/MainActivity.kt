        ...
        setContent {
            ...
            LinuxTheme {
                Scaffold(
                    ...
                    NavHost(navController, startDestination = Screen.Basics.route, Modifier.padding(innerPadding)) {
                        ...
                        composable(
                            ...
                            deepLinks = listOf(
                                navDeepLink { uriPattern = "$deepLinkUri/basic/{deepLinkCategoryName}.html" },
                                navDeepLink { uriPattern = "$deepLinkUri/basic/{deepLinkCategoryName}" })
                        ) { backStackEntry ->
                            val categoryName = backStackEntry.arguments?.getString("deepLinkCategoryName") ?: ""
...
sealed class Screen(val route: String, @StringRes val resourceId: Int, @DrawableRes val drawableRes: Int) {
